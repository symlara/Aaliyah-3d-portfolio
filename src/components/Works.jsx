  ...
  return (
    <motion.div variants={fadeIn("up", "spring", index * 0.5, 0.75)}>
      ...
      >
        ...
        <div className="inset-0 flex justify-end margin-3 card-img_hover">
          <div
            className="absolute mt-[-100px] black-gradient w-10 h-10 rounded-full flex justify-center items-center cursor-pointer"
